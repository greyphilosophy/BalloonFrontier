...
class PlayerState:
    ...
    def save(self, path: str = "~/.balloon_frontier/save.json"):
    ...
    @classmethod
    def load(cls, path: str = "~/.balloon_frontier/save.json") -> "PlayerState":
